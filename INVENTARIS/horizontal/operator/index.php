                                ...
                                <a href="index.php"><i class="mdi mdi-airplay"></i>Dashboard</a>
                                    ...
                                    <li <?php if ($PAGE=="barang") { ?> class="active" <?php  } ?>>
                                     ...
                                     <li <?php if ($PAGE=="siswa") { ?> class="active" <?php  } ?>>
                                        <a href="?page=siswa"><i class="fa fa-book"></i> <span>DATA SISWA</span></a>
                                    </li>
                                    <li <?php if ($PAGE=="pinjam") { ?> class="active" <?php  } ?>>
                                        <a href="?page=pinjam"><i class="fa fa-users"></i> <span>PEMEMINJAM</span></a>
                                    </li>
                                    <li <?php if ($PAGE=="kembali") { ?> class="active" <?php  } ?>>
                                        <a href="?page=kembali"><i class="fa fa-list-ol"></i> <span>PENGEMBALIAN</span></a>
                                    </li>
