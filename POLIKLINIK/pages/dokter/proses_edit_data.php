...
$TLP                           = mysqli_real_escape_string($CONNECT, @$_POST['telp_dok']);
$KODE_POLI                     = mysqli_real_escape_string($CONNECT, @$_POST['kode_poli']);
$KODE_JADWAL                   = mysqli_real_escape_string($CONNECT, @$_POST['jadwal']);
...
<?php
        ...
        $QUERY1=mysqli_query($CONNECT,"UPDATE tb_dokter SET
