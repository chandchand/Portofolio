...
$ID 		= $_GET['id'];
$dua 		= mysqli_real_escape_string($CONNECT,@$_POST['kode_jenis_biaya']);
...
{
  $query = mysqli_query($CONNECT,"INSERT INTO `tb_rekam_medis_biaya` VALUES ('', '$ID', '$dua');") or die (mysql_error());
