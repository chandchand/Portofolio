                            ...
                            <li class="list-inline-item dropdown notification-list">
                                <div class="dropdown notification-list nav-pro-img">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                        ...
                                        <a class="dropdown-item" href="editprofil.php?id"><i class="mdi mdi-account-circle m-r-5"></i> Profile</a>
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                <a href="index.php"><i class="mdi mdi-airplay"></i>Dashboard</a>
                                    ...
                                    @$PAGE = $_GET['page'];
                                    ?>
                                    <li <?php if ($PAGE=="barang") { ?> class="" <?php  } ?>>
                                        <a href="?page=barang"><i class="fa fa-user"></i> <span>Barang</span></a>
                                    </li>
                                    <li <?php if ($PAGE=="jenis_barang") { ?> class="active" <?php  } ?>>
                                        <a href="?page=jenis_barang"><i class="fa fa-user"></i> <span>Jenis Barang</span></a>
                                    </li>
                                    ...
                                    <li class="has-submenu">
                                        <a href="#"><i class="fa fa-print"> Laporan</i></a>
                                        <ul class="submenu megamenu">        
                                            <li>
                                                <ul>
                                                <li><a href="../laporan/Belanja Pengunjung.php" target="_blank"><i class="fa fa-user"></i> Laporan Belanja</a></li>
                                                <li><a href="../laporan/Penerimaan Toko.php" target="_blank"><i class="fa fa-user"></i> Laporan Penerimaan</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>                        
