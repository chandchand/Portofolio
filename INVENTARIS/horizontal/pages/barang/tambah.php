     ...
     <body>
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO daftar_barang(kode_barang, nama_barang, ket, qty) VALUES('$kode_barang', '$nama_barang','$ket', '$qty')") or die(mysqli_error($koneksi));
				
				if($sql){
					echo '<script>alert("Berhasil menambahkan data."); document.location="../../operator/index.php?page=barang";</script>';
				}else{
		...
		<form action="tambah.php" method="post">
			 <div class="card-body">            
                                <h5 class="mt-1 header">Tambah Barang</h5>
                                <br>
                                ...
                                <input type="text" class="form-control" maxlength="5" name="kode_barang" id="placement"  required />
<br>
