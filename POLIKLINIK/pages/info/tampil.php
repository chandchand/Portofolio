        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Nama Instansi</h3>
            </div>
            <?php  
            if (@$_POST['edit_info']) {
              include "../pages/info/proses_edit.php"; 
            }
             if (@$_POST['edit_logo']) {
            ...
            <form role="form" method="POST">
              ...
              <div class="box-footer">
                <input type="submit" class="btn btn-primary" name="edit_info">
              </div>
          ...
          <!-- /.box -->
                <div class="form-group">
                  ...
                  <div class="col-lg-12 col-md-2">
                    <img src="../images/<?php echo $informasi['logo_poliklinik'] ?>">
                  </div>
                </div>
